...
(function(win) {
	var root = win.GV.WEB_ROOT+win.GV.JS_ROOT || location.origin + '/public/js/', //在wind.js加载之前定义GV.JS_ROOT
		...
		alias = {
            ...
            swfobject          : 'swfobject',
            imgready           : 'imgready',
			cityPicker         : 'region/js/city-picker',
			global             : 'global',
			...
			myTreeTable       : 'treeTable1.4.2/jquery.treeTable',
            draggable         : 'draggable',
			...
			minicolors		  : 'minicolors/jquery.minicolors.min',
		...
		alias_css = {
            ...
            treeTable   : 'treeTable/treeTable',
			myTreeTable : 'treeTable1.4.2/vsStyle/jquery.treeTable',
            jcrop       : 'jcrop/css/jquery.Jcrop.min',
            layer       : 'layer/skin/layer',
			plupload    : 'plupload/plupload',
			cityPicker  : 'region/css/city-picker',
			more		: 'more/more',
			minicolors	: 'minicolors/jquery.minicolors',
			iCheck		: 'iCheck/blue',
			fancybox	: 'fancybox/jquery.fancybox',
		};
